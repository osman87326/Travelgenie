...
function AuthProvider(_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data_1 = _a.sent();
                        throw new Error((data_1 === null || data_1 === void 0 ? void 0 : data_1.message) || "Login failed.");
    ...
    return (React.createElement(AuthContext.Provider, { value: { user: user, isLoading: isLoading, login: login, logout: logout } }, children));
}
