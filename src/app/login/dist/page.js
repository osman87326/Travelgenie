...
function Login() {
    var _this = this;
    var _a = AppContext_1.useApp(), login = _a.login, isAuthenticated = _a.isAuthenticated, loadingUser = _a.loadingUser, dbMode = _a.dbMode;
    var _b = react_1.useState(''), email = _b[0], setEmail = _b[1];
    var _c = react_1.useState(''), password = _c[0], setPassword = _c[1];
    var _d = react_1.useState(false), loading = _d[0], setLoading = _d[1];
    var _e = react_1.useState(false), googleLoading = _e[0], setGoogleLoading = _e[1];
    var _f = react_1.useState(''), errorMsg = _f[0], setErrorMsg = _f[1];
    ...
    var handleAutofill = function (type) {
        var creds = {
    ...
    return (react_1["default"].createElement("div", { className: "min-h-screen bg-slate-900 text-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden" },
        ...
        react_1["default"].createElement("div", { className: "max-w-md w-full space-y-8 z-10" },
            react_1["default"].createElement("div", { className: "text-center" },
                ...
                react_1["default"].createElement("h2", { className: "text-2xl font-black text-slate-100" }, "Sign in to your account"),
                react_1["default"].createElement("p", { className: "mt-2 text-xs text-slate-400" },
                    "Or",
                    ' ',
                    react_1["default"].createElement(link_1["default"], { href: "/register", className: "font-semibold text-indigo-400 hover:text-indigo-300 transition-colors" }, "register a new workspace profile"))),
            dbMode === 'local' && (react_1["default"].createElement("div", { className: "rounded-xl bg-amber-500/10 border border-amber-500/20 p-3.5 flex items-start gap-2.5 text-xs text-amber-300" },
                react_1["default"].createElement(lucide_react_1.Database, { className: "w-4.5 h-4.5 text-amber-400 mt-0.5 flex-shrink-0" }),
                react_1["default"].createElement("p", null,
                    react_1["default"].createElement("span", { className: "font-bold" }, "Running locally:"),
                    " Seeding mock credentials. Logins will read from and persist tasks into local memory database."))),
            react_1["default"].createElement("div", { className: "bg-slate-950/40 border border-slate-800 rounded-2xl p-6 shadow-2xl glass" },
                react_1["default"].createElement("form", { className: "space-y-4", onSubmit: handleSubmit },
                    ...
                    react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement("div", { className: "relative" },
                            ...
                            react_1["default"].createElement("input", { type: "email", required: true, value: email, onChange: function (e) { return setEmail(e.target.value); }, placeholder: "admin@zenboard.com", className: "w-full rounded-xl border border-slate-800 bg-slate-900/60 pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-600 focus:border-indigo-500 focus:outline-none" }))),
                    react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement("div", { className: "relative" },
                            ...
                            react_1["default"].createElement("input", { type: "password", required: true, value: password, onChange: function (e) { return setPassword(e.target.value); }, placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", className: "w-full rounded-xl border border-slate-800 bg-slate-900/60 pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-600 focus:border-indigo-500 focus:outline-none" }))),
                    react_1["default"].createElement("button", { type: "submit", disabled: loading, className: "w-full flex justify-center items-center gap-1.5 h-11 rounded-xl bg-indigo-600 text-sm font-semibold text-white shadow hover:bg-indigo-700 transition-colors disabled:opacity-50" },
                        react_1["default"].createElement(lucide_react_1.LogIn, { className: "w-4 h-4" }),
                ...
                react_1["default"].createElement("div", { className: "mt-6 border-t border-slate-800 pt-5 space-y-3" },
                    react_1["default"].createElement("h4", { className: "text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center flex items-center justify-center gap-1" },
                        react_1["default"].createElement(lucide_react_1.Sparkles, { className: "w-3.5 h-3.5 text-indigo-400" }),
                        "Demo Credentials Autofill"),
                    react_1["default"].createElement("div", { className: "grid grid-cols-3 gap-2 text-[11px]" },
                        react_1["default"].createElement("button", { type: "button", onClick: function () { return handleAutofill('admin'); }, className: "py-2 px-2.5 rounded-lg border border-slate-800 bg-slate-900/60 hover:bg-slate-800 text-slate-300 font-medium transition-colors" }, "Sarah (PM)"),
                        react_1["default"].createElement("button", { type: "button", onClick: function () { return handleAutofill('dev'); }, className: "py-2 px-2.5 rounded-lg border border-slate-800 bg-slate-900/60 hover:bg-slate-800 text-slate-300 font-medium transition-colors" }, "Alex (Dev)"),
                        react_1["default"].createElement("button", { type: "button", onClick: function () { return handleAutofill('designer'); }, className: "py-2 px-2.5 rounded-lg border border-slate-800 bg-slate-900/60 hover:bg-slate-800 text-slate-300 font-medium transition-colors" }, "Emma (Design)"))))),
