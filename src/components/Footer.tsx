      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/" className="hover:text-teal-400 transition-colors">Home Landing</Link></li>
              <li><Link href="/explore" className="hover:text-teal-400 transition-colors">Explore Catalog</Link></li>
              <li><Link href="/about" className="hover:text-teal-400 transition-colors">Our Story (About)</Link></li>
              <li><Link href="/contact" className="hover:text-teal-400 transition-colors">Support (Contact)</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-600 gap-4">
          ...
          <div className="flex space-x-6">
            ...
            <Link href="/contact" className="hover:text-slate-400 transition-colors">Cookies Settings</Link>
          </div>
        </div>
      </div>
    </footer>
